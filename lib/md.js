...
// <details>/<summary>/</details> and <div>/</div> passthrough lines for
// collapsible sections and layout wrappers (e.g. a callout box).
...
const RAW_HTML_LINE = /^<\/?(details|summary|div)(\s[^<>]*)?>([^<>]*<\/(details|summary|div)>)?$/i;
